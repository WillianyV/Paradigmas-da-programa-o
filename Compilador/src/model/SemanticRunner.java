...
class SemanticRunner {
    ...
    void run2(Token token) throws SemanticError {
        ...
        this.appendSourceCode(Util.SUB);
    }
    ...
    run3(Token token) throws SemanticError {
        ...
        this.appendSourceCode(Util.MUL);
    }
    ...
    void run4(Token token) throws SemanticError {
        ...
        this.appendSourceCode(Util.DIV);
    }
    ...
    void run5(final String lexeme) {
        this.types.push(Util.INT);
        this.appendSourceCode(Util.LDC_I8 + lexeme);
    }
    ...
    void run6(final String lexeme) {
        this.types.push(Util.FLOAT);
        this.appendSourceCode(Util.LDC_R8 + lexeme);
    }
     ...
     */
    void run7() {
        this.appendSourceCode(String.format(Util.PRINT, this.types.pop()));
    }
    ...
    void run9(Token token) throws SemanticError {
        ...
        this.appendSourceCode(Util.LDC_I8_1);
        this.appendSourceCode(Util.MUL);
    }
    ...
    void run10(Token token) throws SemanticError {
        ...
        switch (this.operator) {
            case Util.EQUALS:
                this.appendSourceCode(Util.CEQ);
                break;
            case Util.LESS_THAN:
                this.appendSourceCode(Util.CLT);
                break;
            case Util.GREATER_THAN:
                this.appendSourceCode(Util.CGT);
                break;
            case Util.NOT_EQUAL:
                this.appendSourceCode(Util.CEQ);
                this.appendSourceCode(Util.LDC_I4_0);
                this.appendSourceCode(Util.CEQ);
                break;
            case Util.LESS_THAN_OR_EQUAL:
                this.appendSourceCode(Util.CLT);
                this.appendSourceCode(Util.LDC_I4_0);
                this.appendSourceCode(Util.CEQ);
                break;
            case Util.GREATER_THAN_OR_EQUAL:
                this.appendSourceCode(Util.CGT);
                this.appendSourceCode(Util.LDC_I4_0);
                this.appendSourceCode(Util.CEQ);
                break;
    ...
    void run12() {
        this.types.push(Util.BOOLEAN);
        this.appendSourceCode(Util.LDC_I4_1);
    }
    ...
    void run14(Token token) throws SemanticError {
        ...
        this.appendSourceCode(Util.LDC_I4_1);
        this.appendSourceCode(Util.XOR);
    }
    ...
    void run15(final String fileName) {
        this.appendSourceCode(String.format(Util.PROGRAM_HEADER, fileName, fileName));
    }
     ...
     */
    void run16() {
        this.appendSourceCode(Util.RET);
        this.appendSourceCode(Util.CLOSE_BRACES);
     ...
     */
    void run18() {
        this.types.push(Util.STRING);
        this.appendSourceCode(Util.LDSTR + SPACE + SCAPED_LINE_BREAK);
    }
    ...
    void run19(Token token) throws SemanticError {
        ...
        this.appendSourceCode(Util.AND);
    }
    ...
    void run21(final String lexeme) throws SemanticError {
        ...
        this.appendSourceCode(Util.LDSTR + SPACE + lexeme);
    }
    ...
    private void convertType() {
        switch (this.idType) {
            case "inteiro":
                this.idType = Util.INT;
                break;
            case "real":
                this.idType = Util.FLOAT;
                break;
            case "caracter":
                this.idType = Util.STRING;
                break;
            case "logico":
                this.idType = Util.BOOLEAN;
                break;
        }
    }
...
//        this.symbolTable.put(lexeme, null);
    ...
    void run34(String lexeme) {
        ...
        switch (lexeme) {
            case "inteiro":
                this.symbolTable.put(this.moduleName, new Symbol(Util.INT, "F", symbol.parameters));
                break;
            case "real":
                this.symbolTable.put(this.moduleName, new Symbol(Util.FLOAT, "F", symbol.parameters));
                break;
            case "caracter":
                this.symbolTable.put(this.moduleName, new Symbol(Util.STRING, "F", symbol.parameters));
                break;
            case "logico":
                this.symbolTable.put(this.moduleName, new Symbol(Util.BOOLEAN, "F", symbol.parameters));
                break;
        }
    ...
    void run35() {
        this.symbolTable.put(this.moduleName, new Symbol(Util.VOID, "P", null));
    }
